...
/* package */ final class Messages
    extends NLS
{
    private static final String BUNDLE_NAME = "com.e1c.dt.check.internal.md.check.messages"; //$NON-NLS-1$
    ...
    public static String ConfigurationUsedMobileApplicationFunctionalitiesCheck_Unsupported_property__0;
