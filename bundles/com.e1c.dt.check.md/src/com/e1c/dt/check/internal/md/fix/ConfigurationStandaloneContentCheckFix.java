...
public class ConfigurationStandaloneContentCheckFix
    extends MultiVariantModelBasicFix
{
    ...
    protected void buildVariants()
    {
        ...
        builder
            .description(Messages.ConfigurationStandaloneContentCheckFix_Remove_bad_content_item_title,
                Messages.ConfigurationStandaloneContentCheckFix_Remove_bad_content_item_description)
