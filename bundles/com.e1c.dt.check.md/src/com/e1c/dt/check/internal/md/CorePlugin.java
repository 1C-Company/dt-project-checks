...
public class CorePlugin
    extends Plugin
{
    public static final String PLUGIN_ID = "com.e1c.dt.check.md"; //$NON-NLS-1$
    ...
    private Injector createInjector()
    {
        ...
        {
            RuntimeException runtimeException = new RuntimeException("Failed to create injector for " //$NON-NLS-1$
