    ...
    extends BasicCheck
{
        ...
        IProgressMonitor progressMonitor)
    {
            ...
            && configuration.getUsePurposes().contains(ApplicationUsePurpose.MOBILE_DEVICE))
        {
            ...
            {
                checkMobileApplicationUrls(configuration, resultAceptor);
            }
        }
    }
     ...
     */
    private void checkMobileApplicationUrls(Configuration configuration, ResultAcceptor resultAceptor)
    {
