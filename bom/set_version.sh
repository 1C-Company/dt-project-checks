...
find . -name 'MANIFEST.MF' -exec sed -i "s/\(com\.e1c\.dt[\.a-z0-9]*;version=\"\)\([\.0-9]*\)\"/\1${new_version}\"/g" {} +

find . -name 'MANIFEST.MF' -exec sed -i "s/\(com\.e1c\.dt[\.a-z0-9]*;version=\"\[\)\([\.,0-9]*)\"\)/\1${new_version},${next_version})\"/g" {} +
find . -name 'MANIFEST.MF' -exec sed -i "s/\(com\.e1c\.dt[\.a-z0-9]*;bundle-version=\"\[\)\([\.,0-9]*)\"\)/\1${new_version},${next_version})\"/g" {} +
